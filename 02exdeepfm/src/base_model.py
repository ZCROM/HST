...
class BaseModel(object):
    def __init__(self, hparams, iterator, scope=None):
        ...
        self.regular_loss = self._compute_regular_loss(hparams) # l2-loss
    ...
    def _get_initializer(self, hparams):
        if hparams.init_method == 'tnormal':
            return tf.truncated_normal_initializer(stddev=hparams.init_value) # init_value == 0.01 truncated
